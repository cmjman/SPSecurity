...
public class HoloCircularProgressBar extends View {
	...
	private Paint mRatingNumberPaint = new Paint();
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		setRatingColor(attributes.getColor(R.styleable.HoloCircularProgressBar_rating_color,Color.CYAN));
		...
		mRatingNumberPaint=new Paint(Paint.ANTI_ALIAS_FLAG);
		mRatingNumberPaint.setColor(mRatingColor);
		mRatingNumberPaint.setStyle(Paint.Style.STROKE);
		mRatingNumberPaint.setStrokeWidth(mRatingWidth);
		mRatingNumberPaint.setTextSize(180);
		mRatingNumberPaint.setTextAlign(Align.CENTER);
	...
	protected void onDraw(final Canvas canvas) {
		...
		final int ratingNumber=getCurrentRatingNumber();
		...
		canvas.drawText(String.valueOf(ratingNumber), 0, 50, mRatingNumberPaint);
	...
	private int getCurrentRatingNumber() {
	
		return (int)(100*mProgress);
	}
	...
	private void setRatingColor(final int color){
		mRatingColor=color;
	}
